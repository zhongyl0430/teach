前已指出, 数理统计的核心任务是 “从局部推断整体”, 具体地讲, 从样本 $\left( {{X}_{1},{X}_{2},\cdots,{X}_{n}}\right)$ 出发, 推断总体 $X$ 的统计特性. 
在中学教材中,大家学过的频率直方图就是一种用样本观测值近似拟合总体分布密度函数的直观方法. 
那么, 从理论上讲,从局部能够推断整体吗? 
或者说样本 $\left( {{X}_{1},{X}_{2},\cdots,{X}_{n}}\right)$ 何时才能近似反映总体 $X$ 的特性呢?
