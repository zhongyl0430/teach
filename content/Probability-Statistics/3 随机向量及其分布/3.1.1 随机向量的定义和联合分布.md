...
我们称定理 3.1.1 中的性质 (i)-(iv) 为随机向量分布函数的特征性质, 也就是说, 若有定义于 ${\mathbb{R}}^{n}$ 上的实函数 $F$ 满足性质 1-4, 则可以构造一个概率空间 $\left( {\Omega,\mathcal{F}, P}\right)$ 和其上的随机向量 $\left( {{X}_{1},{X}_{2},\cdots,{X}_{n}}\right)$, 使
$$
