...
## 解 
由题意设 $X \sim  U\left\lbrack  {a, b}\right\rbrack$, 则 
$$E\left\lbrack  X\right\rbrack   = \frac{a + b}{2},\operatorname{Var}\left\lbrack  X\right\rbrack   = \frac{{\left( b - a\right) }^{2}}{12} ,$$
即
$$
