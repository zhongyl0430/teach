...
$$
\begin{align}
P\left( |X - \mu| \leq 1\sigma \right) &= 2 \times \text{pnorm}(1) - 1 \\
&= 0.6826895, \\
P\left( |X - \mu| \leq 2\sigma \right) &= 2 \times \text{pnorm}(2) - 1 \\
&= 0.9544997, \\
P\left( |X - \mu| \leq 3\sigma \right) &= 2 \times \text{pnorm}(3) - 1 \\
&= 0.9973002.
\end{align}
$$
## 应用
