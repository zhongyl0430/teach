公共汽车车门的高度是按男子与车门顶碰头的机会在 0.01 以下来设计的. 现设男子身高 $X$ 服从参数 $\mu  = {170}\left( \mathrm{\;{cm}}\right)$ 和 $\sigma  = 6\left( \mathrm{\;{cm}}\right)$ 的正态分布, 即 $X \sim  N\left( {{170}, {6}^{2}}\right)$. 试确定车门的高度.
