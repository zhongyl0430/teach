Let’s determine the following standard normal probabilities: (a) $P\left( {Z \leq {1.25}}\right)$ , (b) $P\left( {Z > {1.25}}\right)$ ,(c) $P\left( {Z \leq - {1.25}}\right)$ ,(d) $P\left( {-{.38} \leq Z \leq {1.25}}\right)$ , and (e) $P\left( {Z \leq 5}\right)$ .
