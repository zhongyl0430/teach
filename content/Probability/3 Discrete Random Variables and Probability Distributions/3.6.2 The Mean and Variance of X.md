Since $b\left( {x;n,p}\right) \rightarrow p\left( {x;\mu }\right)$ as $n \rightarrow \infty$, $p \rightarrow 0$, ${np} \rightarrow \mu$ , the mean and variance of a binomial variable should approach those of a Poisson
variable. 
